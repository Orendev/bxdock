                    ...
                    <tr>
                        <td align=left style="/*font-size:14pt;color:#E11537;padding-left:25px*/">
                            <h3 class="content-header"
                                style="margin: 0;padding: 0;text-align: left;"><?= $ar['HEAD'] ?></h3>
                            <hr style="margin: 15px 0;">
                        </td>
                    </tr>
                    <tr>
                        <td style="font-size:10pt"
                            valign="<?= $ar['TEXT_ALIGN'] ? $ar['TEXT_ALIGN'] : 'middle' ?>"><?= $ar['TEXT'] ?></td>
                    </tr>
                    <tr>
                        <td style="font-size:10pt; padding-top: 20px" valign="middle" align="center"
